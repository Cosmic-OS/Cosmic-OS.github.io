...
(function() {
  ...
  var burgerMenu = function() {
    ...
    $('body').on('click', '.js-inf-nav-toggle', function(event) {
  ...
  var clickMenu = function() {
    ...
    $('a:not([class="external"])').click(function(event) {
      ...
      if (navbar.is(':visible')) {
        ...
        $('.js-inf-nav-toggle').removeClass('active');
      }
  ...
  var windowScroll = function() {
    ...
    $(window).scroll(function(event) {
      ...
      var header = $('#inf-header'),
        scrlTop = $(this).scrollTop();

      if (scrlTop > 500 && scrlTop <= 2000) {
        header.addClass('navbar-fixed-top inf-animated slideInDown');
      } else if (scrlTop <= 500) {
        if (header.hasClass('navbar-fixed-top')) {
          header.addClass('navbar-fixed-top inf-animated slideOutUp');
          setTimeout(function() {
            header.removeClass('navbar-fixed-top inf-animated slideInDown slideOutUp');
          }, 100);
        }
      }
  ...
  var servicesAnimate = function() {
    ...
    if ($('#inf-our-services').length > 0) {
      $('#inf-our-services .to-animate').each(function(k) {
  ...
  var servicesWayPoint = function() {
    ...
    if ($('#inf-our-services').length > 0) {
      $('#inf-our-services').waypoint(function(direction) {
  ...
  var featuresAnimate = function() {
    ...
    if ($('#inf-features').length > 0) {
      $('#inf-features .to-animate').each(function(k) {
  ...
  var featuresWayPoint = function() {
    ...
    if ($('#inf-features').length > 0) {
      $('#inf-features').waypoint(function(direction) {
  ...
  var testimonialsAnimate = function() {
    ...
    if ($('#inf-testimonials').length > 0) {
      $('#inf-testimonials .to-animate').each(function(k) {
  ...
  var testimonialsWayPoint = function() {
    ...
    if ($('#inf-testimonials').length > 0) {
      $('#inf-testimonials').waypoint(function(direction) {
  ...
  var pricingAnimate = function() {
    ...
    if ($('#inf-pricing').length > 0) {
      $('#inf-pricing .to-animate').each(function(k) {
  ...
  var pricingWayPoint = function() {
    ...
    if ($('#inf-pricing').length > 0) {
      $('#inf-pricing').waypoint(function(direction) {
  ...
  var pressAnimate = function() {
    ...
    if ($('#inf-press').length > 0) {
      $('#inf-press .to-animate').each(function(k) {
  ...
  var pressWayPoint = function() {
    ...
    if ($('#inf-press').length > 0) {
      $('#inf-press').waypoint(function(direction) {
